...
- **Description:** Gồm có các core script  bao gồm BoardGenerator, AutoplayHandler, GameManager, TileManager trong folder Script xử lý các nhiệm vụ core theo yêu cầu bài toán đưa ra.
